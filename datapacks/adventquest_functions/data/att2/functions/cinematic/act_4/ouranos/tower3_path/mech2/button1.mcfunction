...
execute positioned 7415 191 6467 run summon minecraft:wolf ~ ~ ~ {Tags:["LVL0","CLASS1","Reg4","BattleMusic"],DeathLootTable:"att2:empty",Silent:1,Invulnerable:1,NoAI:1,PersistenceRequired:1,ActiveEffects:[{Id:14,Amplifier:1,Duration:2147483647,Ambient:1,ShowParticles:0b}]}