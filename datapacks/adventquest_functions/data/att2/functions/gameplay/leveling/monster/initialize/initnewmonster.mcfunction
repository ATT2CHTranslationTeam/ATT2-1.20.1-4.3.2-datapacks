...
execute if score level DIFFICULTY matches -1 as @s[scores={CLASSLEVEL=1..21}] run data merge entity @s {ActiveEffects:[{Id:18,Amplifier:0,Duration:2147483647,Ambient:1,ShowParticles:0b},{Id:2,Amplifier:0,Duration:2147483647,Ambient:1,ShowParticles:0b}]}
...
execute if score level DIFFICULTY matches 0 as @s[scores={CLASSLEVEL=1..21}] run data merge entity @s {ActiveEffects:[{Id:11,Amplifier:0,Duration:2147483647,Ambient:1,ShowParticles:0b}]}
...
execute if score level DIFFICULTY matches 1 as @s[scores={CLASSLEVEL=1..21}] run data merge entity @s {ActiveEffects:[{Id:11,Amplifier:1,Duration:2147483647,Ambient:1,ShowParticles:0b}]}
...
execute if score level DIFFICULTY matches 2 as @s[scores={CLASSLEVEL=1..21}] run data merge entity @s {ActiveEffects:[{Id:11,Amplifier:2,Duration:2147483647,Ambient:1,ShowParticles:0b},{Id:1,Amplifier:1,Duration:2147483647,Ambient:1,ShowParticles:0b},{Id:5,Amplifier:1,Duration:2147483647,Ambient:1,ShowParticles:0b}]}
